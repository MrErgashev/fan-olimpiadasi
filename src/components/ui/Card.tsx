    ...
    <div
      className={cn(
        "rounded-2xl relative overflow-hidden",
        {
          ...
          glass: variant === "glass",
          "bg-white/5 border border-white/10 backdrop-blur-xl": variant === "solid",
          "glass border border-primary-500/20": variant === "gold",
          ...
          "glass border border-white/[0.08] hover:border-primary-500/20 hover:shadow-xl hover:shadow-primary-500/10 hover:-translate-y-1 transition-all duration-300 cursor-pointer":
            variant === "interactive",
          "glass-strong p-8 sm:p-10 border border-white/[0.1] bg-gradient-to-br from-primary-950/60 to-app-dark/60":
            variant === "feature",
        },
        hover &&
